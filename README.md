...
1. Ejecuta `sql/017_reporte_asistencia_automatico.sql` en el editor SQL de Supabase.
...
Los destinatarios, la hora, el estado activo y el historial de envios se guardan en Supabase. La contrasena de Gmail nunca se guarda en Supabase ni se envia al navegador.
